...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.spinBox_board = QtWidgets.QSpinBox(Form)
        self.spinBox_board.setObjectName("spinBox_board")
        self.horizontalLayout_3.addWidget(self.spinBox_board)
        self.label_4 = QtWidgets.QLabel(Form)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_3.addWidget(self.label_4)
        self.spinBox_channel = QtWidgets.QSpinBox(Form)
        self.spinBox_channel.setMaximum(36)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "层数："))
        self.label_4.setText(_translate("Form", "通道："))
